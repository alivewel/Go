...
func main() {
	...
	*/
	requests := []Request{
		{"T", parseTime2("00:10:21"), "A", "FORBIDDEN", false},
		{"T", parseTime2("00:30:22"), "A", "DENIED", false},
		{"YA", parseTime2("00:00:01"), "A", "ACCESSED", false},
		{"VK", parseTime2("00:30:23"), "A", "ACCESSED", false},
		{"YA", parseTime2("00:40:23"), "A", "ACCESSED", false},
	}
...
// мы подразумеваем, что у нас события, которые поступают на вход, отосортированы по времени в формате неубывания (аналогично логам).
